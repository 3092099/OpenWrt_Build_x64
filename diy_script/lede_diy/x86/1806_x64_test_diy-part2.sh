#!/bin/bash
#===============================================
# Description: 1806_x64_test DIY script part 2
# File name: 1806_x64_test_diy-part2.sh
# Lisence: MIT
# By: GXNAS
#===============================================
...
uci set network.lan.ipaddr='192.168.1.11'                    # 设置本机 IPv4 地址
uci set network.lan.gateway='192.168.1.1'                    # 设置 IPv4 网关
uci set network.lan.dns='223.5.5.5 114.114.114.114'          # 设置 DNS(多个DNS要用空格分开)
